...
<c:if test="${adListing!=null}">
    ...
    <a href="<c:url value="${pageContext.request.requestURL}">
        ...
        <img src="<c:url value="/resources/asc.png"/>" width="20" height="19" border="0" align="absmiddle" alt="">
    </a>
    <a href="<c:url
    ...
    <img src="<c:url value="/resources/desc.png"/>" width="20" height="19" border="0" align="absmiddle">
    </a>
    </td>
    <td>
    Автор<br>
